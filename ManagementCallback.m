...
%             SimulationId(NumOfSimRun)=InboundMessage.SimulationId;
% 
...
% 
%             Object(NumOfSimRun)=StateMonitoring(SimulationSpecificExchange,SimulationId(NumOfSimRun),PGOName,Grid,RS,MaxVoltage,MinVoltage,UpperAmberBandVoltage,LowerAmberBandVoltage,OverloadingBaseline,AmberLoadingBaseline);
...
%                 tf=strcmp(SimulationId(i),InboundMessage.SimulationId);
%                 sum=sum+tf;
%             end
%                 if sum==0
%                     NumOfSimRun=NumOfSimRun+1;
...
%                     AmberLoadingBaseline=PredictiveGridOptimizationBlock.(PGOName).AmberLoadingBaseline;
% 
%                     Object(NumOfSimRun)=StateMonitoring(SimulationSpecificExchange,SimulationId(NumOfSimRun),PGOName,Grid,MaxVoltage,MinVoltage,UpperAmberBandVoltage,LowerAmberBandVoltage,OverloadingBaseline,AmberLoadingBaseline);
%                     Handles{NumOfSimRun} = @() Object(NumOfSimRun).Main;
%                     States{NumOfSimRun}=parfeval(@() Object.Main,1);
%                 end  
%         end       
